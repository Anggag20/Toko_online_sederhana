...
//agar ga double di katogori saat mengeditnya
        ...
        <div class="col-12 col-md-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <img src="../image/<?php echo $data['foto']; ?>" width="300px" height="200px" alt="">
                </div>
                <div>
            ...
            ?>
                                <div class="alert alert-warning mt-3" role="alert">
                                   File Foto Harus Kurang dari 500kb
                                </div>
            <?php
                            }
                            else{
            ...
            ?>
                                   <div class="alert alert-warning mt-3" role="alert">
                                       File type Harus jpg atau png atau gif
                                   </div>
            <?php
                                }
                               else{
